...
class TimeEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_entry" do
    assert_difference("TimeEntry.count") do
      post time_entries_url, params: { time_entry: { action: @time_entry.action, people_id_id: @time_entry.people_id_id, time: @time_entry.time } }
    end
  ...
  test "should update time_entry" do
    patch time_entry_url(@time_entry), params: { time_entry: { action: @time_entry.action, people_id_id: @time_entry.people_id_id, time: @time_entry.time } }
