class ContactFormsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @contact_form.update(contact_form_params)
        format.html { redirect_to @contact_form, notice: "Contact form was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to contact_forms_path, notice: "Contact form was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_contact_form
      @contact_form = ContactForm.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def contact_form_params
      params.expect(contact_form: [ :name, :email ])
    end
end
